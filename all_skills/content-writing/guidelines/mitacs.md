...
1. Website URL:  https://www.mitacs.ca/ 
2. Status: Approved  
3. Production Plan ID: 1yAJ3QkX7TovCFbclCmAsxozOxOGkDS2d24KM_gef9ZY
4. Tab Name: 'ON SITE - Calendrier éditorial'
5. On-Site Content Folder: https://drive.google.com/drive/folders/1HjO1ViPJ18G0mgs6OFigSuXd9HncsagF 
6. On-Site Content Deliverable Template (FR): https://docs.google.com/document/d/1x3SR4oNqXhNNK9O0YsYT5JPewwzaadkG6BIAvPCkZa4/edit?usp=sharing
6b. On-Site Content Deliverable Template (EN): https://docs.google.com/document/d/1tPoOoUuftM6dhup5aEsKfkdV-pAwoxMvSRwBetizIFo/edit?usp=sharing
7. Neuronwriter Project: https://app.neuronwriter.com/project/view/8a4e2dcb175bf071/optimisation
8. Column Mapping: month=E, year=F, heading=K, keyword=M, secondary=N, type=H, url=Q, doc_output=O, nw_output=R, language=I, status=C, header_row=4

# MITACS – Writing Guidelines & Guide de rédaction
...
| Accélération Entrepreneur | `https://www.mitacs.ca/fr-ca/programmes/accelerate-entrepreneur/` |
| Conseillers et conseillères | `https://www.mitacs.ca/fr-ca/a-propos/conseillers-conseilleres-mitacs/` |
