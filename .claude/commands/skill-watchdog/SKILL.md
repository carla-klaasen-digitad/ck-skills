...
| Natural session end | User message contains "done", "wrap up", "that's it", "close", "finish", or the session ends with no new messages for 30+ minutes |
...
2. Immediately run Phase 5.1–5.8.
3. Log `[INFO] — Forced-close triggered by: [signal]. Phase 4 + Phase 5 complete. Registry and Drive sync done.`
